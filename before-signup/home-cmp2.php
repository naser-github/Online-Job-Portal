...
<body>
    ...
    <div class="container">
        <div class="row">
            ...
            <?php
                $sql = "select * from job where cmp_name LIKE '%$cmp_name%' order by job_id desc" ;
                $isql= $con->query($sql);
                    ...
                    ?>
                        <div class="card">
                            <div class="card-header">
                                ...
                                <a href="job-view.php?var=<?php echo $job_id;?>"> <?php echo $row["job_title"] ?> </a> <br>
                                <?php echo "Company Name: ".$row["cmp_name"] ?> <br>
                            </div>
                            <div class="card-body">
