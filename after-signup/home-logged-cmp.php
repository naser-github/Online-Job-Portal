...
<body>
    ...
    <?php
        ...
        if(isset($_POST['cmp_s'])){
            ...
            if($isql->num_rows>0){
                ...
                header("location:home-logged-cmp2.php");
            }else{
                ?>
                <script>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
                <li class="nav-item active">
                    <a class="nav-link" href="../home-logged-cmp.php">Home <span class="sr-only">(current)</span></a>
                </li>
                <li class="nav-item">
    ...
    <div class="card bg-dark text-white">
        ...
        <div class="card-img-overlay">
            ...
            <div>
                <a class="img-overlay" href="../home-logged.php">Jobs</a>
                &nbsp; &nbsp; &nbsp; &nbsp;
                <a class="img-overlay active-1" href="home-logged-cmp.php">Companies</a>
            </div>
        </div>
    </div>
    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="container">
                <div class="row">
                    <div class="col-md-3">
                        <a href="../afcat/accounting.php" class="catagory-home"> Accounting/Finnace </a></li>
                    </div>
                    <div class="col-md-3">
                ...
                <div class="row">
                    <div class="col-md-3">
                        <a href="../afcat/selectricial.php" class="catagory-home"> Electrician </a>
                    </div>
                    <div class="col-md-3">
                        <a href="#" class="catagory-home"> Garments/Textile </a>
                    </div>
                    <div class="col-md-3">
                        <a href="../afcat/it.php" class="catagory-home"> IT & Telecomunication </a>
                    </div>
                    <div class="col-md-3">
