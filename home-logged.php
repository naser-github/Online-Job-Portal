...
<body>
    ...
    <?php
        ...
        if(isset($_POST['title_s'])){
            ...
            if($isql->num_rows>0){
                ...
                header("location:after-signup/job-search.php");
            }else{
                ?>
                <script>
    ...
    <div class="card bg-dark text-white">
        ...
        <form class="form-inline my-2 my-lg-0 justify-content-center"
            ...
            <div>
                <a class="img-overlay active-1" href="home-logged.php">Jobs</a>
                &nbsp; &nbsp; &nbsp; &nbsp;
                <a class="img-overlay" href="after-signup/home-logged-cmp.php">Companies</a>
            </div>
        </div>
    </div>
