...
include '../db_con.php';
    if(isset($_POST['submit'])){
        $email = mysqli_real_escape_string($con,$_POST['s_mail']);
        $pass = mysqli_real_escape_string($con,$_POST['s_pass']);
        ...
        $check_email = "select * from seeker where sk_email = '$email' and sk_pass = '$pass' ";
...
?>
    ...
    <div class="sign-box">
        <form action="<?php echo htmlentities($_SERVER['PHP_SELF']); ?>" method="POST">
            <br><br>
            Email Id <br>
            <input class="form-control mr-sm-2" name="s_mail" type="email" placeholder="email"> <br>
            Password <br>
            <input class="form-control mr-sm-2" name="s_pass" type="password" placeholder="Pass"> <br>
            <input type="checkbox" name="remember">
            <label for="remember"> Remember me</label><br>
            <button class="btn btn-outline-white" type="submit" name="submit">Log In</button> <br><br>

            <a href="sign-up-sk.php">
