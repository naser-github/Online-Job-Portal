...
$seeker_mail = $_SESSION['seeker_mail'];
include "../db_con.php";
?>
...
<body>
    ...
    <?php
        if(isset($_POST['delete'])){
            ...
            $sql = "DELETE FROM job_apply WHERE seeker_sk_email = '$seeker_mail' ";
            $isql = $con->query($sql);
            
            if($isql===true){
                    
                $sql2 = "DELETE FROM seeker WHERE sk_email = '$seeker_mail' ";
                ...
                if($isql2===true){
                    ...
                    <?php
                    header("location:admin-seeker.php");
                }else{
                    ?>
                    <script>
                        alert("Error!!!");
        ...
        <div class="row">
            <div class="col-md-10 block">
                <div class="card">
                   ...
                   <?php
                        $sql = "select * from seeker where sk_email = '$seeker_mail' ";
                        $isql = $con->query($sql);
                        ...
                        if($isql->num_rows>0){
                            ...
                            ?><div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <a href="admin-seeker4.php?var=<?php echo $seeker_email;?>" target="blank">View CV</a> <br>
                                        <a href="admin-seeker5.php?var=<?php echo $seeker_email;?>" target="blank">Download CV</a>
                                    </div>
                                </div>
                            <?php
                            }
