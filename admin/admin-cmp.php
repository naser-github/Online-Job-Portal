...
<body>
    ...
    <?php
        ...
        if(isset($_POST['title_s'])){
            ...
            $sql = "select * from job where cmp_name LIKE '%$name_p%' " ;
            $isql = $con->query($sql);
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
                <li class="nav-item active">
                    <a class="nav-link" href="admin-cmp.php">Home <span class="sr-only">(current)</span></a>
                </li>
                <li class="nav-item">
    ...
    <div class="card bg-dark text-white">
        ...
        <form class="form-inline my-2 my-lg-0 justify-content-center"
            ...
            <div>
                <a class="img-overlay" href="admin-home.php">Jobs</a>
                &nbsp; &nbsp; &nbsp; &nbsp;
                <a class="img-overlay active-1" href="admin-cmp.php">Companies</a>
            </div>
        </div>
    </div>
