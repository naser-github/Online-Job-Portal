...
<body>
    ...
    <?php
        ...
        if(isset($_POST['title_s'])){
            ...
            if($isql->num_rows>0){
                session_start();
                $_SESSION['job_title'] = $name_p;
                header("location:before-signup/job_search.php");
            }else{
                ?>
                <script>
                ...
                <li class="nav-item dropdown">
                    ...
                    <?php
                        ...
                        if(isset($_COOKIE[$cookie_name])) {
                            echo '<a class="dropdown-item" href="home-logged.php">'.'As an Seeker'.'</a>';
                        }
                        else{
                            echo '<a class="dropdown-item" href="home-sign/sign-in-sk.php">'.'As an Seeker'.'</a>';
                        }
                    ?>  
                    <div class="dropdown-divider"></div>
                    <?php
                         $cookie_name = 'user';
                        if(isset($_COOKIE[$cookie_name])) {
                            echo '<a class="dropdown-item" href="emp/home-log-emp.php">'.'As an Employee'.'</a>';
                        }
                        else{
                            echo '<a class="dropdown-item" href="home-sign/sign-in-emp.php">'.'As an Employee'.'</a>';
                        }
                    ?> 
                        <a class="dropdown-item" href="home-sign/sign-in-emp.php"></a>
                    </div>
                </li>
                <li>&nbsp; &nbsp; &nbsp; &nbsp;</li>
            </ul>    
    ...
    <div class="card bg-dark text-white">
        ...
        <div class="card-img-overlay">
            ...
            <div>
                <a class="img-overlay active-1" href="home.php">Jobs</a>
                &nbsp; &nbsp; &nbsp; &nbsp;
                <a class="img-overlay" href="before-signup/home-cmp.php">Companies</a>
            </div>
        </div>
    </div>
