...
<body>
    ...
    <?php
        ...
        if(isset($_POST['dlt'])){
            ...
            $sql = "DELETE FROM job WHERE job_id = '$j_id' ";
            $isql = $con->query($sql);
...
?>
    ...
    <form action="<?php echo htmlentities($_SERVER['PHP_SELF']); ?>" method="POST">
        <div class="btn-group bb" role="group" aria-label="Basic mixed styles example">
            <input type="text" name="j_id" placeholder="Input Job Id" required>
            <button type="submit" name="dlt" class="btn btn-danger">Delete a post</button>
        </div>
    </form>
