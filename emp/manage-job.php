...
?>
    ...
    <div class="btn-group bb" role="group" aria-label="Basic mixed styles example">
        <a href="manage-job-up.php" >
            <button type="button" class="btn btn-warning">Edit a post</button>
        </a>
        &nbsp; &nbsp; &nbsp;
        <a href="manage-job-dlt.php">
        <button type="button" class="btn btn-danger"> Delete a post</button>
        </a>
    </div>
